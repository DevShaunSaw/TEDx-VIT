...
export default function GetTicket () {
  return (
    <>
      <Navbar />
      <div className="ticket-text" style={{cursor: 'default', paddingTop: '64px'}}>
          ...
          <h2 style={{ textAlign: 'center', marginTop: '24px', fontSize: '24px', color: '#EEEEEE' }}>When The Confirmation Page with "All Set" Success Message Arrives. You Can <Link href="/ticket" style={{color: '#FF0000'}}>View Ticket</Link> on The Site.</h2>
        </div>
        <iframe src="https://konfhub.com/widget/tedx-vit-2026-touching-the-soul?desc=false&secondaryBg=ff0000&ticketBg=ff0000&borderCl=ff0000&bg=000000&fontColor=ffffff&ticketCl=ffffff&btnColor=000000&fontFamily=Figtree&borderRadius=24&widget_type=quick&screen=2&tickets=83152&ticketId=83152%7C1" id="konfhub-widget" title="Register for TEDx VIT 2026 - Touching The Soul" width="100%" height="750" style={{ marginTop: '24px'}}></iframe>
      <MiniFooter/>
    </>
  )
}